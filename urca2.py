...
def project_th3_over_f2(th3, z_min=-np.inf, z_max=np.inf):
    ...
    print(x_centers, z_centers, values)
...
def main(th3_signal, th3_bkg):
    ...
    f1_cut_val = f1_min + (f1_max - f1_min) * tf.sigmoid(cut_raw).numpy()
    hard_f1 = (f1_centers > f1_cut_val).astype(int)
